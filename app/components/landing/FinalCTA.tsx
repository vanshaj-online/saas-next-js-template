    ...
    <section className="py-32 ">
      <div className="mx-auto max-w-7xl px-pad-sm">
        <div className="relative overflow-hidden rounded-3xl border border-border py-24 px-pad-sm text-center shadow-[0_15px_40px_rgba(0,0,0,0.03)]">
          <div
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[600px] w-[600px] rounded-full pointer-events-none opacity-[0.5]"
            style={{
              background:
                'radial-gradient(ellipse at center, rgba(255,255,255, 0.3), transparent 65%)',
              filter: 'blur(50px)',
            }}
          />
