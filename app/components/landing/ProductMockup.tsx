        ...
        <div className="relative mx-auto max-w-7xl mt-20 ">
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] min-h-[460px]">
                    {/* sidebar */}
                    <aside className="hidden md:block border-r border-border bg-neutral-900 p-4 space-y-1">
                    ...
                    {/* main content */}
                    <div className="p-4 sm:p-6 flex flex-col justify-between bg-neutral-900">
                        <div>
